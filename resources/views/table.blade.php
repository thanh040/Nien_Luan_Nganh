            ...
            <div>
                <table>
                    ...
                    <tr>
                        ...
                        <td>Xây dựng mô hình phân lớp trên dữ liệu không cân bằng với giải thuật RUSboost, EasyEnsemble, BalanceCascade áp dụng để chẩn đoán bệnh</td>
                        <td>Đỗ Quốc Đạt</td>
                        <td>B1111490</td>
                        <td>K37</td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>Khoa Học Máy Tính</td>
                        <td>Xây dựng ứng dụng hỗ trợ triển khai lớp học trực tuyến thông qua hệ thống web conference dựa trên nền tảng mã nguồn mở</td>
                        <td>Đinh Quốc Chương</td>
                        <td>B1310374</td>
                        <td>K39</td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td>Khoa Học Máy Tính</td>
                        <td>Xây dựng mô hình phân lớp dữ liệu không cân bằng tiếp cận với chi phí,áp dụng trên các tập dữ liệu chẩn đoán bệnh.</td>
                        <td>Lê Văn Tài</td>
                        <td>B1117850</td>
                        <td>K37</td>
                    </tr>
